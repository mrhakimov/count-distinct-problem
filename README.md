...
- ___void add(int x);___ — добавить число x к набору;
- ___int get_uniq_num();___ — возвращает приблизительное количество различных чисел, которые были переданы в функцию add.
